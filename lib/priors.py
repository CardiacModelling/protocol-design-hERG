...
prior_parameters = {
        '23.0': np.array([  # 18020906E11
         ...
         3.14264169312376893e+01,]) * 1e-3,
        '36.0': np.array([  # 18020702G20
         ...
         2.74163520256361117e+01,]) * 1e-3
    }
# Unit in mV, ms


#
# Set up prior for HH IKr model
#
class HHIKrLogPrior(pints.LogPrior):
    """
